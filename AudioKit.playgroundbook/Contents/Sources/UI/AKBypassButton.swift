...
open class AKBypassButton: UIView {
    ...
    ///
    public init(node: AKToggleable, frame: CGRect = CGRect(x: 0, y: 0, width: 540, height: 60)) {
        self.node = node
    ...
    func drawBypassButton(isBypassed: Bool = false) {
        ...
        //// bypassGroup
        //// bypassOuter Drawing
        bypassOuterPath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 270, height: 60))
        bypassingCOlor.setFill()
        bypassOuterPath.fill()


        //// bypassLabel Drawing
        let bypassLabelRect = CGRect(x: 0, y: 0, width: 270, height: 60)
        ...
        processOuterPath = UIBezierPath(rect: CGRect(x: 270, y: 0, width: 270, height: 60))
        processingColor.setFill()
        processOuterPath.fill()


        //// processLabel Drawing
        let processLabelRect = CGRect(x: 270, y: 0, width: 270, height: 60)
