...
open class AKResourcesAudioFileLoaderView: UIView {
    ...
    public convenience init(player: AKAudioPlayer, filenames: [String], frame: CGRect = CGRect(x: 0, y: 0, width: 540, height: 60)) {
    ...
    func drawAudioFileLoader(fileName: String = "None") {
        ...
        //// background Drawing
        let backgroundPath = UIBezierPath(rect: CGRect(x: 0, y: 0, width: 540, height: 60))
        darkgray.setFill()
        backgroundPath.fill()
        ...
        //// upButton
        //// upOuter Drawing
        upOuterPath = UIBezierPath(rect: CGRect(x: 481, y: 0, width: 59, height: 30))
        ...
        upInnerPath.move(to: CGPoint(x: 495.75, y: 22.5))
        upInnerPath.addLine(to: CGPoint(x: 525.25, y: 22.5))
        upInnerPath.addLine(to: CGPoint(x: 510.5, y: 7.5))
        upInnerPath.addLine(to: CGPoint(x: 510.5, y: 7.5))
        upInnerPath.addLine(to: CGPoint(x: 495.75, y: 22.5))
        upInnerPath.close()
        dark.setFill()
        upInnerPath.fill()
        ...
        //// downButton
        //// downOuter Drawing
        downOuterPath = UIBezierPath(rect: CGRect(x: 481, y: 30, width: 59, height: 30))
        backgroundColor.setFill()
        downOuterPath.fill()
        ...
        downInnerPath.move(to: CGPoint(x: 510.5, y: 52.5))
        downInnerPath.addLine(to: CGPoint(x: 510.5, y: 52.5))
        downInnerPath.addLine(to: CGPoint(x: 525.25, y: 37.5))
        downInnerPath.addLine(to: CGPoint(x: 495.75, y: 37.5))
        downInnerPath.addLine(to: CGPoint(x: 510.5, y: 52.5))
        downInnerPath.close()
        dark.setFill()
        downInnerPath.fill()
        ...
        //// nameLabel Drawing
        let nameLabelRect = CGRect(x: 120, y: 0, width: 380, height: 60)
